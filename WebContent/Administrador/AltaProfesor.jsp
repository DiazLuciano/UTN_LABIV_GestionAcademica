...
%>
		...
		<div class="container">
			<h1 style="color:#F0F2F4;margin-top: 20px">Formulario Profesor</h1>
		</div>
				...
				<div class="card-body">
  				...
  				<div class="form-row">
				    <div class="col-md-6 mb-3">
				      ...
				      <input name="txtDireccion" type="text" class="form-control" id="validationCustom04" placeholder="Direccíon" required>
				      <div class="invalid-feedback">
				        Dirección inválida
				      </div>
				   </div>
				    ...
				    <div class="col-md-6 mb-3">
				      ...
				      <input maxlength="15" name="txtTelefono" type="number" class="form-control" id="validationCustom08" placeholder="Cód.Área (sin +) + número" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" required>
				      <div class="invalid-feedback">
				        Teléfono inválido
				      </div>
				    </div>
				    <div class="col-md-6 mb-3">
				      <label for="validationCustom09">Nombre de usuario</label>
				      <input maxlength="20" name="txtusuario" type="text" class="form-control" id="validationCustom08" placeholder="username" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" required>
				      <div class="invalid-feedback">
				        user inválido
				      </div>
				    </div>
				    <div class="col-md-6 mb-3">
				      ...
				      <input maxlength="20" name="txtcontraseña" type="text" class="form-control" id="validationCustom08" placeholder="contraseña" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" required>
				      <div class="invalid-feedback">
				        contraseña inválida
				      </div>
				    </div>
				</div>
  			<input type="submit" class="btn btn-primary" name="btnAgregarDocente" value="Guardar">
		</form>
	</div>
</div>
</div>
