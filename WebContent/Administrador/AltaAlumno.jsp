				...
				<div class="card-body">
  				...
  				<div class="form-row">
				    ...
				    <div class="col-md-6 mb-3">
				      ...
				      <input maxlength="15" name="txtTelefono" type="number" class="form-control" id="validationCustom08" placeholder="Cód.Área + Número" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" required>
				      <div class="invalid-feedback">
				        Teléfono inválido
				      </div>
				    </div>
