...
%>
	...
	<div>
		...
		<div class="container">
			<h1 style="color:#F0F2F4;margin-top: 20px">Modificar Profesor</h1>
		</div>
		
		<div class="container" style="margin-top:20px">
			<div class="card" style="background:#F0F2F4">
				<div class="card-body">
					<form class="needs-validation" action="ServletDocentes" method="post" novalidate>
						<div class="form-row">
							<div class="col-md-6 mb-3">
	 							<div class="form-group">
      								<label>Legajo</label>
      								<input readonly="readonly" name="txtLegajo" type="number" value="<%= doc.getLegajo() %>" class="form-control">
    							</div>
    						</div>
    			
			  				<div class="col-md-6 mb-3">
			      				<label for="validationCustom00">DNI</label>
			      				<input name="txtDNI" type="number" class="form-control" id="validationCustom00" placeholder="DNI" value="<%= doc.getDni() %>" required>
						    ...
						    <div class="col-md-6 mb-3">
						    	...
						    	<input name="txtNombreApellido" type="text" class="form-control" id="validationCustom01" placeholder="Nombre" value="<%= doc.getNombre_apellido() %>" required>
						      		<div class="invalid-feedback">
						    ...
						    <div class="col-md-6 mb-3">
								...
								<input name="txtFnac" type="date" class="form-control" id="validationCustom03" value="<%= doc.getFecha_nac() %>" required>
						        	<div class="invalid-feedback">
						        		Fecha inválida
						      		</div>
						    </div>
  					...
  					<div class="form-row">
					    <div class="col-md-6 mb-3">
					      ...
					      <input name="txtDireccion" type="text" class="form-control" id="validationCustom04" placeholder="Direccíon" value="<%= doc.getDireccion() %>"  required>
					      	<div class="invalid-feedback">
					        	Dirección inválida
					      	</div>
					    </div>
				      	...
				      	<div class="container" >
							...
							<%
								...
								for(String prov : lista){
									...
									if(prov.equals(doc.getProvincia())){
						...
						<div class="container">
					    	<select  style="margin-left:-15px" class="form-control" name="localidad" >
								...
								for(String loc : lista2){
									...
									if(loc.equals(doc.getLocalidad())){
										System.out.println("SEEE");
							%>		
				    ...
				    <div class="col-md-6 mb-3">
				      ...
				      <input name="txtEmail" type="Email" class="form-control" id="validationCustom07" placeholder="Email" value="<%= doc.getEmail() %>"  required>
				      	<div class="invalid-feedback">
				       		Email inválido
				      	</div>
				    </div>
				    ...
				    <div class="col-md-6 mb-3">
				      ...
				      <input name="txtTelefono" type="tel" class="form-control" id="validationCustom08" placeholder="Teléfono" value="<%= doc.getTelefono() %>"  required>
				      	<div class="invalid-feedback">
				        	Teléfono inválido
				      	</div>
				    </div>
